...
export default function LandingFooter({ productName }: LandingFooterProps) {
  return (
    <footer className="relative bg-white transition-colors dark:bg-slate-950">
      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="grid gap-10 py-12 sm:grid-cols-12 md:py-16">
          ...
          <div className="space-y-3 sm:col-span-12 lg:col-span-4">
            ...
            >
              <span className="inline-flex h-8 w-8 items-center justify-center rounded-lg bg-indigo-500 text-sm font-bold text-white">
          ...
          {FOOTER_COLUMNS.map((column, colIndex) => (
            <div
              key={colIndex}
              className="space-y-3 sm:col-span-6 md:col-span-3 lg:col-span-2"
            >
